package com.proyecto.nodotrabajador1;
...
public class NodoTrabajador1Application implements CommandLineRunner {

    public static void main(String[] args) {
        SpringApplication.run(NodoTrabajador1Application.class, args);
    }
